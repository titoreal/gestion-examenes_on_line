...
This name allows to macodigopulate them via JavaScript in order to perform some validation for instance.
*/
...
$pdf->ComboBox('gender', 30, 5, array(array('', '-'), array('M', 'Masculino'), array('F', 'Femenino')));
$pdf->Ln(6);
