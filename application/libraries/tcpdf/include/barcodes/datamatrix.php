...
// -----------------------------------------------------------------------------
	...
	public function __construct($code) {
		...
		// get micodigoeum required matrix size.
	...
	/**
	 * Choose the micodigoeum matrix size and return the max number of data codewords.
	...
	/**
	 * Get high level encoding using the micodigoeum symbol data characters for ECC 200
	 * @param string $data data to encode
