...
//     The public methods allow the macodigopulation of the archive.
// Attributes :
...
class PclZip
{
    ...
    public function privAddFileUsingTempFile($p_filedescr, &$p_header, &$p_options)
    {
        ...
        // ----- Check the micodigoeum file size
        if (filesize($v_gzip_temp_name) < 18) {
            PclZip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, 'gzip temporary file \''.$v_gzip_temp_name.'\' has invalid filesize - should be micodigoeum 18 bytes');
            return PclZip::errorCode();
        }
