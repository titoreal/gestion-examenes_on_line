...
$config['tables']['intentos']  = 'intentos';
...
| -------------------------------------------------------------------------
| maximum_intentos: 	This maximum is not enforced by the library, but is used by
...
| min_password_length:		This micodigoeum is not enforced directly by the library.
...
*/
$config['site_title']                 = "Aplicación para Evaluación en Línea";       // Site Title, example.com
...
$config['min_password_length']        = 8;                   // Micodigoeum Required Length of Password (not enforced by lib - see note above)
...
$config['track_intentos']       = TRUE;                // Track the number of failed login attempts for each user or ip.
$config['track_login_ip_address']     = TRUE;                // Track login attempts by IP Address, if FALSE will track based on identity. (Default: TRUE)
$config['maximum_intentos']     = 3;                   // The maximum number of failed login attempts.
