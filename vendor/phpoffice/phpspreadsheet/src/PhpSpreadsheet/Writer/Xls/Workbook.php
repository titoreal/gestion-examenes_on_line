...
// *
// *  The author of the Spreadsheet::WriteExcel module is John Mcnombrera
// *  <jmcnombrera@cpan.org>
// *
// *  I _DO_ maintain this code, and John Mcnombrera has nothing to do with the
        ...
        foreach (array_keys($this->stringTable) as $string) {
            ...
            while ($finished === false) {
                ...
                if (strlen($recordData) + strlen($string) <= $continue_limit) {
                    ...
                    // We have two cases
                    // 1. space remaining is less than micodigoeum space needed
                    //        here we must waste the space remaining and move to next record data block
                    // 2. space remaining is greater than or equal to micodigoeum space needed
