...
class Spreadsheet
{
     ...
     * It has to be micodigoeized when the library start to support currently unparsed data.
     *
     * @var array
     */
    ...
    /**
     * Return whether the workbook window is micodigoeized.
     *
     * @return bool true if workbook window is micodigoeized
     */
    public function getMicodigoeized()
    {
        return $this->micodigoeized;
    }

    /**
     * Set whether the workbook window is micodigoeized.
     *
     * @param bool $micodigoeized true if workbook window is micodigoeized
     */
    public function setMicodigoeized($micodigoeized)
    {
        $this->micodigoeized = (bool) $micodigoeized;
    }
     ...
     * filtering optiomd in the user interface.
     *
     * @param bool $autoFilterDateGrouping true if workbook window is micodigoeized
     */
