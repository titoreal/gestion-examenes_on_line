...
class Axis extends Properties
{
     ...
     * @param string $micodigoeum
     * @param string $maximum
     * @param string $major_unit
     * @param string $minor_unit
     */
    public function setAxisOptionsProperties($axis_labels, $horizontal_crosses_value = null, $horizontal_crosses = null, $axis_orientation = null, $major_tmt = null, $minor_tmt = null, $micodigoeum = null, $maximum = null, $major_unit = null, $minor_unit = null)
    {
        ...
        ($minor_tmt !== null) ? $this->axisOptions['minor_tick_mark'] = (string) $minor_tmt : null;
        ($micodigoeum !== null) ? $this->axisOptions['micodigoeum'] = (string) $micodigoeum : null;
