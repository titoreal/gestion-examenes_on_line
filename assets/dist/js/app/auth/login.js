$(document).ready(function(){
    ...
    $('form#login').on('submit', function(e){
        ...
        infobox.addClass('callout callout-info').text('Validando...');

        var btnsubmit = $('#submit');
        btnsubmit.attr('disabled', 'disabled').val('Cargando...');
        ...
        success: function(data){
            ...
            if(data.status){
                infobox.addClass('callout callout-success text-center').text('Acceso Correcto');
